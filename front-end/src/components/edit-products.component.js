            ...
            <div className='container-fluid'>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className='float-child'>
                        ...
                        <img src={this.state.product_img_preview} width='300px' height='400px'/> :
                            <img src={this.state.product_img} width='300px' height='400px'/>}
                    </div>
                    ...
                    <div className="form-group">
                        {
                            this.state.is_disabled !== true ? <input type="submit" className="btn btn-info" value="Save"/>: ''
                        }
                ...
                {
                    this.state.is_disabled !== false ? <button className='btn btn-info' onClick={this.enableEditing}>{this.state.btn_update}</button>: ''
                }
